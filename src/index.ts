import TarefaProps from "./interface_tarefa";

let listElement = document.querySelector("#app ul") as HTMLUListElement;
let inputTarefa = document.querySelector("#app textarea") as HTMLTextAreaElement;
let inputData = document.querySelector("#data-input") as HTMLInputElement;
...
let tarefas: TarefaProps[] = listaStorage !== null && JSON.parse(listaStorage) || [];
...
function adicionarTarefa(): boolean | void {
    // Verifica se já existe tarefa igual
